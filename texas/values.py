...
def is_high_card(figure, hand):
    """
    >>> is_high_card("K", ["Ka", "3a", "6a", "4a"])
    True
    >>> is_high_card("3", ["Ka", "3a", "6a", "4a"])
    False
    """
    hand_value = sorted([figures.index(cards[:-1]) for cards in hand])
    return figure == figures[max(hand_value)]
...
def is_four(figure, hand):
    """
    >>> is_four("3", ["3a", "3a", "3a", "3a"])     
    True
    >>> is_four("2", ["3a", "3a", "3a", "3b"])     
    False
    >>> is_four("3", ["Ka", "Ka", "6a", "6b"])     
    False
    """
...
high_card = [partial(is_high_card, figure=f)for f in figures[::-1]]
...
def hand_value(cards):
    ...
    True
    >>> hand_value(["2z", "2a", "3q", "3w", "3a"]) < hand_value(["4z", "4a", "3q", "3w", "3a"])
    True
    >>> hand_value(["Jz", "Ja", "3q", "3w", "3a"]) < hand_value(["4z", "4a", "5q", "5w", "5a"])
    True
